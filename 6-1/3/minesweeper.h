...
public:
    ...
    void set_underbar(size_t W, size_t H, vector<string>& map2);
    vector<string> set_Map(size_t W, size_t H, vector<string>& map, vector<string>&num);
    void toggleMine(size_t x, size_t y, size_t lx, size_t ly, vector<string>& map, vector<string>& num);
    //int set_Map2(size_t W, size_t H, vector<string>& map);
